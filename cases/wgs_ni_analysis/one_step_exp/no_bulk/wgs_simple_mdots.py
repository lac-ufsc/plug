...
#Save data to file
wgs_simple = {'co_conv': co_conv, 'Tout': np.array(Trange) - 273.15}
...
if vis == 1:
    ...
    co_conv_redux = wgs_data_mdots['co_conv_all']
