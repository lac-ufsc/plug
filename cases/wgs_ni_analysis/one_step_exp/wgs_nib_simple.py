...
savename = 'wgs_nib_simple_fixed.pickle'

#Import surface coverages
filename = ('/home/tpcarvalho/carva/python_data/wgs_ni/wgs_nib_redux.pickle') 
...
#Mean coverages values  
#cov_data_mean = cov_data[:,0,:]
cov_data_mean = np.mean(cov_data,axis=1)
